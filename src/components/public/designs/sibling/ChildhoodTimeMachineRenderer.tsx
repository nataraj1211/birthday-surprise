      ...
      <section className="text-center space-y-5 pt-6 pb-8">
        {!warpCelebrated ? (
          <motion.button
            ...
            className="px-8 py-4 rounded-full bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-600 text-white font-black text-base shadow-xl shadow-sky-600/30 cursor-pointer inline-flex items-center gap-3 transition-all"
          >
            <Sparkles className="w-5 h-5 animate-spin" />
            <span>Engage Full Sibling Time Warp Light Burst 🚀</span>
          </motion.button>
        ) : (
          <motion.div
